...
# Static Cursor team-plan catalog, served through the local Cursor Agent CLI
# (read-only ask mode). The CLI owns the tool loop, so these entries honestly
# advertise no Messages-API tool support.
CURSOR_MODELS: list[dict[str, Any]] = [
    ...
    },
    {
        "id": "gpt-5.3-codex",
        "name": "Codex 5.3",
        "description": "OpenAI Codex 5.3 via the Cursor CLI",
        "provider": "cursor",
        "context_length": 1_000_000,
        "supported_parameters": [],
        "architecture": {"input_modalities": ["text"]},
    },
    {
        ...
        "name": "Codex 5.3 High",
        "description": "OpenAI Codex 5.3 with extra reasoning effort",
        "provider": "cursor",
        "context_length": 1_000_000,
        "supported_parameters": [],
        "architecture": {"input_modalities": ["text"]},
    ...
    },
    {
        ...
        "description": "Fast Gemini 3.7 Flash via the Cursor CLI",
        "provider": "cursor",
        "context_length": 1_000_000,
        "supported_parameters": [],
        "architecture": {"input_modalities": ["text"]},
...
def picker_description(model: dict[str, Any]) -> str:
    ...
    via = {
        ...
        "cursor": "Cursor team plan via claude-router (read-only ask mode)",
